          ...
          >
            ...
            <defs>
              <linearGradient id="gradient-1" x1="0" y1="0" x2="80%" y2="80%">
                <stop stopColor="rgb(81,162,233)" offset="0%"></stop>
                <stop stopColor="rgb(168,120,162)" offset="100%"></stop>
              </linearGradient>
              <linearGradient
                id="gradient-2"
                x1="20%"
                ...
                y2="100%"
              >
                <stop stopColor="rgb(168,120,162)" offset="0%"></stop>
                <stop stopColor="rgb(255,77,90)" offset="100%"></stop>
              </linearGradient>
            </defs>
          </svg>
